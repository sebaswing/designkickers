...
<div id="contenedorgeneral">
	...
	<form method="get" action="miscouch.php">
		...
		<nav> <!-- Aqui estamos iniciando la nueva etiqueta nav -->
				<ul class="nav">
					<li><a href="javascript:cargarcouch('todosmiscouch');">Mis Couch</a>
						<ul>							
							<li><a href="todosmiscouch.php">Publicados</a></li>
							<li><a href="misCouch.php">Sin publicar</a></li>
						</ul>
					</li>
					<li><a href="usuariocomun.php">Todos los Couch</a>
                      ...
                      if(isset($_GET['Ubicacion']) or isset($_GET['Categoria']))
                      {
	                      if($_GET['Ubicacion']!=null and $_GET['Categoria']!=null)
	                      {
	                      	  $sql= "SELECT DISTINCT c.mail nombre,
	                             ...
	                             WHERE (f.id_couch=c.id_couch and c.mail = '".$_SESSION['mail']."' and f.fotoperfil=1 and u.mail=c.mail and c.id_ciudad='".$_GET['Ubicacion']."'
	                      ...
	                      else if($_GET['Ubicacion']!=null)
	                      {
	                      	  $sql= "SELECT DISTINCT c.mail nombre,
	                                    ...
	                                    u.numTarjeta tarjeta
	                             FROM couch c INNER JOIN fotografia f INNER JOIN usuario u
	                             WHERE (f.id_couch=c.id_couch and c.mail = '".$_SESSION['mail']."' and f.fotoperfil=1 and u.mail=c.mail and c.id_ciudad='".$_GET['Ubicacion']."') ORDER BY f.id_fotografia DESC";
	                      }
	                      else if ($_GET['Categoria']!=null) 
	                      {
	                      	  $sql= "SELECT DISTINCT c.mail nombre,
	                                    ...
	                                    u.numTarjeta tarjeta
	                             FROM couch c INNER JOIN fotografia f INNER JOIN usuario u
	                             WHERE (f.id_couch=c.id_couch and c.mail = '".$_SESSION['mail']."'  and f.fotoperfil=1 and u.mail=c.mail and c.id_categoria='".$_GET['Categoria']."') ORDER BY f.id_fotografia DESC";
	                      }
	                       else 
                      		{	
		                      $sql= "SELECT DISTINCT c.mail nombre,
		                                    ...
		                                    u.numTarjeta tarjeta
		                             FROM couch c INNER JOIN fotografia f INNER JOIN usuario u
		                             WHERE (f.id_couch=c.id_couch and c.mail = '".$_SESSION['mail']."' and f.fotoperfil=1 and u.mail=c.mail) ORDER BY f.id_fotografia DESC";
	                       }
		                  }
                      else 
                      {	
